...
describe('AxialCurvesFactory', () => {
  ...
  describe('toObject3D should return', () => {
    ...
    describe('expected object', () => {
      ...
      it('for a parallel segment, without intermediate points, rightwards', () => {
      ...
      it('for a parallel segment, without intermediate points, leftwards', () => {
        const merged = service.createObject3D(layer, [[12, 15, 10, 15]]);
        const expected = [[1.880, 0.400, 0.515], [1.893, 0.334, 0.515]];
        assertGeometryExpected(merged.geometry as BufferGeometry, expected);
      });

      it('for a parallel segment, with one intermediate point, rightwards', () => {
      ...
      it('for a parallel segment, with one intermediate point, leftwards', () => {
      ...
      it('for a parallel segment, with multiple intermediate points, rightwards', () => {
      ...
      it('for a parallel segment, with multiple intermediate points, leftwards', () => {
      ...
      it('for a meridional segment, with one intermediate point, downwards', () => {
      ...
      it('for a meridional segment, with multiple intermediate points, upwards', () => {
      ...
      it('for a meridional segment, with multiple intermediate points, downwards', () => {
