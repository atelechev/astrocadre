import { CenteredText } from 'src/app/modules2/core/models/layers/factories/text/centered-text';
import { CloseRightText } from 'src/app/modules2/core/models/layers/factories/text/close-right-text';
