...
describe('TextOffsetPolicy', () => {
  ...
  it('#TextOffsets.ZERO_OFFSETS should be 0 for X and Y', () => {
  ...
  it('#TextOffsetPolicies.CENTERED should return (0, 0) if text is undefined', () => {
    const element = document.createElement('div');
    const offsets = centeredPolicy.calculateOffsets(undefined, element);
    assertOffsetsExpected(0, 0, offsets);
  });

  it('#TextOffsetPolicies.CENTERED should return (0, 0) if element is undefined', () => {
